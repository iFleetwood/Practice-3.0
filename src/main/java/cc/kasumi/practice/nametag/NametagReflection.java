...
/**
 * Reflection utility for nametag packets, similar to ScoreboardReflection
 */
public final class NametagReflection {
    ...
    public static PacketConstructor findPacketConstructor(Class<?> packetClass, MethodHandles.Lookup lookup) throws Exception {
        ...
        if (theUnsafe == null) {
            synchronized (NametagReflection.class) {
                if (theUnsafe == null) {
